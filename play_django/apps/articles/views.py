...
class CommentsListCreateAPIView(generics.ListCreateAPIView):
    ...
    def filter_queryset(self, queryset):
        filters = {self.lookup_field: self.kwargs[self.loopkup_url_kwarg]}

        return queryset.filter(**filters)

    def created(self, request, article_slug=None):
        ...
        try:
            ...
            raise NotFound('An article with this slug is not present')
